...
export default function ResultView({ original, alienified, onReset }: ResultViewProps) {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = alienified;
    link.download = "alienified.png";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Alienified */}
        <div className="space-y-3">
          <p className="text-center text-[var(--alien-accent)] font-semibold text-sm uppercase tracking-wider">
            👽 Alienified (superior)
          </p>
          <div className="relative aspect-square rounded-2xl overflow-hidden glass ring-2 ring-[var(--alien-accent)]/50">
            <Image
              src={alienified}
              alt="Alienified result"
              fill
              className="object-cover"
              unoptimized
            />
